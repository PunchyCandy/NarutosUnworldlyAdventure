...
public class NPC_OldMan extends Entity{
    ...
    public void getImage() {
        ...
        up1 = setUp("/npc/oldmanLeft1", gp.tileSize, gp.tileSize);
        up2 = setUp("/npc/oldmanLeft2", gp.tileSize, gp.tileSize);
        down1 = setUp("/npc/oldmanRight1", gp.tileSize, gp.tileSize);
        down2 = setUp("/npc/oldmanRight2", gp.tileSize, gp.tileSize);
